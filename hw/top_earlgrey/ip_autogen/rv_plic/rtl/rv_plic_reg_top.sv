...
module rv_plic_reg_top (
  ...
  always_comb begin
    ...
    addr_hit[187] = (reg_addr == RV_PLIC_IP_0_OFFSET);
    addr_hit[188] = (reg_addr == RV_PLIC_IP_1_OFFSET);
    addr_hit[189] = (reg_addr == RV_PLIC_IP_2_OFFSET);
    addr_hit[190] = (reg_addr == RV_PLIC_IP_3_OFFSET);
    addr_hit[191] = (reg_addr == RV_PLIC_IP_4_OFFSET);
    addr_hit[192] = (reg_addr == RV_PLIC_IP_5_OFFSET);
    ...
    addr_hit[202] = (reg_addr == RV_PLIC_ALERT_TEST_OFFSET);
  end
  ...
  assign ie0_0_we = addr_hit[193] & reg_we & !reg_error;
  ...
  assign ie0_1_we = addr_hit[194] & reg_we & !reg_error;
  ...
  assign ie0_2_we = addr_hit[195] & reg_we & !reg_error;
  ...
  assign ie0_3_we = addr_hit[196] & reg_we & !reg_error;
  ...
  assign ie0_4_we = addr_hit[197] & reg_we & !reg_error;
  ...
  assign ie0_5_we = addr_hit[198] & reg_we & !reg_error;
